...
impl FileWR<'_> {
    ...
    pub fn src_or(&self, src: Vec<Vec<f64>>) -> Vec<Vec<f64>> {
    ...
    pub fn backtest_write(
        ...
        let dir = get_backtest_dir(self.s.backtest.to_str().unwrap(), symbol);
    ...
    pub fn script_backtest_or(&self, script_backtest: String) -> String {
